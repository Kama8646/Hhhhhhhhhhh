...
bot_token = '7491923931:AAELj7xGmahcpd1HkXxu_lq6y30GZBwDEdQ' # nhập token bot telegram

bot = telebot.TeleBot(bot_token)

allowed_group_id = -1002617239722
...
def laykey(message):
    ...
    try:
        ...
        response = requests.get(
            f'https://yeumoney.com/QL_api.php?token=8156cc19fdccefe54eb38837dd06e2b771d2158187c2971a7c7ad7a4735acb96&format=json&url=https://milk-developers.us.kg/Key/?key={key}'
        ).json()
